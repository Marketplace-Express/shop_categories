...
$loader->registerNamespaces([
    ...
    'Shop_categories\RequestHandler\Attributes' => APP_PATH . '/common/request-handler/attributes/',
    'Shop_categories\RequestHandler\Categories' => APP_PATH . '/common/request-handler/categories/',
